---
name: herdr
description: Inspect and control Herdr workspaces, tabs, panes, sessions, and OMP native Plan handoffs.
---
...
Read [references/mode-handoff.md](references/mode-handoff.md) for OMP native
Plan entry. Read
[references/workspace-operations.md](references/workspace-operations.md) for
caller resolution, workspace, tab, pane, command, or coding-agent work.
