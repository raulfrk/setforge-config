...
Install the SetForge OMP profile, which provisions the RevDiff skills, launchers, and automatic Plan workflow plugin.
...
Load the `revdiff-plan` skill to review the last OMP response through the profile's `revdiff_plan` tool.
